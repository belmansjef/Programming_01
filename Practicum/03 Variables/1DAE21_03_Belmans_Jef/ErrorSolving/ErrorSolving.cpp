...
int main()
{
	...
	std::cin >> intNr;
	result = static_cast<float>(sqrt(intNr));
	std::cout << "Square root of this value is " << result << std::endl;
	...
	char letter{};
	std::cin >> letter;
	std::cout << "ASCII value of this letter is " << static_cast<int>(letter) << std::endl;
	...
	char ascii{};
	std::cin >> ascii;
	std::cout << "Letter " << ascii << " corresponds with this ASCII value\n";
